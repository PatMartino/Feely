...
{
    public class MathFundamentalNextLevelUIController : MonoBehaviour
    {
        ...
        private void Init()
        {
            switch (MathFundamentalSignals.Instance.OnGetLevelStatus())
            {
            ...
            difficultyLevelText.text = MathFundamentalSignals.Instance.OnGetLevelID().ToString();
